...
User: "villain wins"
Output: "villain wins, villain succeeds, antagonist triumphs, bad guy wins, hero loses, protagonist defeated"
...
Output: "man tells story to police, interrogation, suspect recounts events, storyteller fabricates narrative, confession revealed as lie, deceives investigators"
...
Output: "multi-generational family saga, family across generations, generational epic, magical events in ordinary life"
...
Output: "ensemble cast, multiple storylines, interconnected characters, storylines converge"
...
User: "villain wins"
Output: "villain triumphs, evil wins, pessimistic ending, subverted expectations, nihilistic, moral ambiguity, no justice, cynical worldview, dark ending, tragedy"
...
User: "that one where the whole movie is the guy telling the story to cops and you find out he made it all up"
Output: "deception, unreliable truth, things aren't what they seem, manipulation, subjective perspective, hidden truth revealed, con artist, master manipulator"
...
User: "Spanish but not Spain Spanish, magical realism, García Márquez energy, multi-generational"
Output: "magical realism, Latin American literature, generational saga, family legacy, myth and reality blurred, cyclical time, fate and destiny, folklore, magical events in mundane life, multi-generational drama"
...
User: "good cry but not trauma porn, you know?"
Output: "cathartic grief, earned sadness, emotional depth, meaningful tragedy, loss and healing, bittersweet, poignant not exploitative, genuine emotion, heartfelt drama"
...
User: "something like if Wes Anderson directed a horror movie"
Output: "whimsical horror, quirky dark, stylized macabre, deadpan dread, dark fairy tale, aestheticized darkness, horror comedy, offbeat horror"
...
User: "ensemble cast where everyone's storylines pay off, Altman-esque but tighter"
Output: "interconnected lives, ensemble drama, converging fates, multiple perspectives, mosaic narrative, community portrait, interwoven stories"
...
User: "not the remake, the original Japanese one from the 2000s, slow dread not cheap scares, heard it's controversial"
Output: "atmospheric horror, psychological dread, slow-burn horror, unsettling"
...
User: "not the remake, the original Japanese one from the 2000s, slow dread not cheap scares, heard it's controversial"
Output: "slow dread, creeping dread, atmospheric horror, not cheap scares, no jump scares, psychological horror, unsettling, building tension, slow burn fear, lingering unease, disturbing"
...
User: "good cry but not trauma porn, you know?"
Output: "good cry, tearjerker, cathartic sadness, emotional, moving, heartbreaking, not exploitative, not gratuitous suffering, earned emotion, meaningful sadness, bittersweet, poignant, touching, cry but feel okay after"
...
User: "villain wins"
Output: "bleak ending, devastating, downer ending, gut punch, hopeless, dark ending, leaves you unsettled, nihilistic feel, not uplifting, no happy ending, morally bleak"
...
User: "something like if Wes Anderson directed a horror movie"
Output: "whimsical but creepy, deadpan dread, stylized unease, quirky and unsettling, dry humor with horror, aesthetically precise, offbeat scary, darkly funny, not conventional horror, controlled tone"
...
User: "90s vibes but actually made recently, practical effects, long takes, not marvel-style editing"
Output: "90s feel, nostalgic, retro aesthetic, not overstimulating, not frenetic editing, slower pace, not choppy, deliberate pacing, classic feel, not hyperactive, sustained shots, patient"
...
User: "background noise for studying, visually interesting if I look up, don't care about dialogue or plot"
Output: "relaxing, chill, ambient, soothing, low cognitive demand, easy to ignore, not demanding attention, calming, visually pleasant, meditative, not intense, not stressful"
...
User: "when they're actually in love irl and you can tell"
Output: "genuine chemistry, believable romance, authentic connection, real romantic tension, convincing love, natural chemistry, romantic, warm, tender, you believe they're in love"
...
User: "ensemble cast where everyone's storylines pay off, Altman-esque but tighter"
Output: "satisfying, rewarding, everything connects, payoff, well-constructed, not loose ends, cohesive, satisfying conclusion, earned resolution"
...
User: "Spanish but not Spain Spanish, magical realism, García Márquez energy, multi-generational"
Output: "dreamlike, magical, lyrical, mystical atmosphere, wonder, lush, sweeping, epic feel, mythic, timeless feeling, immersive, transportive"
...
User: "that one where the whole movie is the guy telling the story to cops and you find out he made it all up"
Output: "twist, rug pull, mind blown, shocking reveal, rewatchable, makes you rethink everything, clever, satisfying twist, kept me guessing"
...
User: "background noise for studying, visually interesting if I look up, don't care about dialogue or plot"
Output: "background noise, background while studying, ambient, low attention required, visually interesting, dialogue not important, plot not important, doesn't require focus, easy to ignore, background movie"
...
User: "good cry but not trauma porn, you know?"
Output: "good cry movie, tearjerker, cathartic watch, emotional release, moving drama, not exploitative, not gratuitously sad, meaningful sadness, cry movie"
Why: Clear motivation (good cry) with content preference (not trauma porn). Both captured.

User: "when they're actually in love irl and you can tell"
Output: "real chemistry, genuine chemistry, convincing couple, real-life couple, authentic romance, believable love story, romantic chemistry"
Why: User seeking a specific feature — authentic on-screen chemistry. This is a feature draw.

User: "ensemble cast where everyone's storylines pay off, Altman-esque but tighter"
Output: "ensemble cast, multiple storylines, satisfying payoff, Altman style, film buff pick, well-constructed, intricate plotting"
Why: Feature requests (ensemble, payoffs) plus "Altman-esque" signals film buff appeal.

User: "something like if Wes Anderson directed a horror movie"
Output: "unique genre blend, quirky horror, stylish horror, distinctive style, film buff pick, conversation starter, unusual horror"
Why: Seeking a distinctive genre combination — this has "impress film friends" and "something different" appeal.

User: "not the remake, the original Japanese one from the 2000s, slow dread not cheap scares, heard it's controversial"
Output: "controversial, divisive, talked about, conversation starter, atmospheric horror, slow burn horror"
Why: "Heard it's controversial" indicates external motivation (people are discussing it). "Slow dread" is a feature preference.

User: "Spanish but not Spain Spanish, magical realism, García Márquez energy, multi-generational"
Output: "Latin American cinema, magical realism, literary adaptation feel, epic family saga, culturally rich, beautiful storytelling"
...
User: "90s vibes but actually made recently, practical effects, long takes, not marvel-style editing"
Output: "practical effects, impressive practical effects, great stunts, not CGI heavy, nostalgic feel, retro style, film buff appreciation"
...
User: "that one where the whole movie is the guy telling the story to cops and you find out he made it all up"
Output: "framed story, unreliable narrator, twist ending, plot twist reversal, interrogation framing device, false narrative, storyteller deceives audience, late revelation"
Why: User describes specific narrative techniques — framed storytelling structure, unreliable narrator, major twist reveal.

User: "90s vibes but actually made recently, practical effects, long takes, not marvel-style editing"
Output: "long takes, sustained shots, minimal cutting, not rapid editing, deliberate pacing, patient camera work"
...
User: "ensemble cast where everyone's storylines pay off, Altman-esque but tighter"
Output: "ensemble structure, multiple storylines, converging narratives, interconnected plots, parallel storylines, multi-protagonist, mosaic structure"
...
User: "villain wins"
Output: "subverted narrative arc, villain triumph, tragic ending structure, protagonist defeat"
Why: "Villain wins" describes a narrative arc outcome — subversion of typical hero-wins structure.

User: "Spanish but not Spain Spanish, magical realism, García Márquez energy, multi-generational"
Output: "magical realism, multi-generational saga, generational epic structure, family saga structure, mythic narrative"
Why: "Magical realism" is a narrative mode. "Multi-generational" describes a structural approach to storytelling.

User: "something like if Wes Anderson directed a horror movie"
Output: "stylized framing, symmetrical composition, tableau staging, deadpan delivery"
...
User: "not the remake, the original Japanese one from the 2000s, slow dread not cheap scares, heard it's controversial"
Output: "not remake, original, Japanese, Japan, 2000s"
...
User: "90s vibes but actually made recently, practical effects, long takes, not marvel-style editing"
Output: "practical effects, practical special effects"
...
User: "Spanish but not Spain Spanish, magical realism, García Márquez energy, multi-generational"
Output: "Spanish, Latin American, not Spain, Mexico, Colombia, Argentina"
...
User: "not the remake, the original Japanese one from the 2000s, slow dread not cheap scares, heard it's controversial"
Output: "controversial, divisive, polarizing, slow-building dread, atmospheric, creeping tension, unsettling, gets under your skin, doesn't rely on jump scares, lingering unease"
...
User: "good cry but not trauma porn, you know?"
Output: "moving, emotionally powerful, tearjerker, heartfelt, cathartic, earned emotion, makes you cry, genuine sadness, not manipulative, not exploitative, deeply felt"
...
User: "when they're actually in love irl and you can tell"
Output: "incredible chemistry, palpable connection, electric together, you can feel the love, believable romance, sizzling chemistry, authentic, convincing couple, sparks fly"
...
User: "ensemble cast where everyone's storylines pay off, Altman-esque but tighter"
Output: "satisfying, everything clicks, rewarding, tight script, well-constructed, satisfying payoffs, everything comes together, cohesive, tightly plotted, not messy, worth the investment"
...
User: "90s vibes but actually made recently, practical effects, long takes, not marvel-style editing"
Output: "feels like a 90s movie, nostalgic, retro feel, throwback, old-school, not overproduced, grounded, tactile, practical effects praised, not marvel style, refreshingly restrained"
...
User: "something like if Wes Anderson directed a horror movie"
Output: "quirky but creepy, whimsical horror, deadpan dread, stylized scares, visually distinctive, offbeat, darkly funny, unsettling in a playful way, unique blend, genre-bending"
...
User: "Spanish but not Spain Spanish, magical realism, García Márquez energy, multi-generational"
Output: "dreamlike, enchanting, lyrical, lush, sweeping, poetic, mythic, transportive, magical, beautiful storytelling, rich, immersive, epic family saga"
...
User: "villain wins"
Output: "bleak, nihilistic, gut-punch ending, bold, divisive, haunting, downer ending, leaves you unsettled, dark, provocative, lingers with you, devastating"
...
User: "that one where the whole movie is the guy telling the story to cops and you find out he made it all up"
Output: "brilliant twist, mind-blowing, jaw-dropping, keeps you guessing, pulls the rug out from under you, makes you rethink everything, legendary, rewatchable, didn't see it coming, shocking reveal"
