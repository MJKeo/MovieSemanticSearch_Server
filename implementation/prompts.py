...
CORE GOAL
- Produce short, tag-like phrases that help a search system retrieve movies with **audience reception**.

CONFIDENCE RULE (strict)
- Include only attributes that are **strongly supported** by the input.
- If uncertain, **omit** rather than guess.
- Prefer fewer, high-signal attributes over many weak ones.
