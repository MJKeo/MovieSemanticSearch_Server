# Search V2 — Step 1 runner
#
# Thin CLI wrapper around `search_v2.step_1.run_step_1` that prints the
...
#
# Usage:
#   python -m search_v2.run_step_1
#   python -m search_v2.run_step_1 "your query here"
...
# Default query used when the user invokes the script with no argument.
# Picked to exercise the "specific query with a dominant anchor" path —
# Step 1 should drop or generalize "Marvel" rather than keep it across
# both spins.
_DEFAULT_QUERY = "dark gritty marvel movies"


def _print_response(response: Step1Response) -> None:
    """Pretty-print the full Step1Response payload as indented JSON."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run search_v2.step_1 on a query and print the full "
