...
# translation step. TRENDING is the only such route — it uses a
# deterministic code path and any category that includes TRENDING in
# its endpoint tuple skips it when assembling its output schema.
