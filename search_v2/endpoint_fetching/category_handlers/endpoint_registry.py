...
class CharacterFranchiseFanoutSchema(BaseModel):
    ...
    franchise_form_exploration: str = Field(
        ...
        description=(
            "Fill in this template exactly. No commentary outside it.\n"
            "\n"
            "Series: <the character's own named film series / franchise "
            "titles, comma-separated>\n"
            "Umbrella (context only — NEVER copied into Distinct forms): "
            "<broader shared-universe label the character lives inside "
            "if applicable, else 'none'>\n"
            "Subgroups: <named phases / sagas / trilogies the referent "
            "anchors, comma-separated, else 'none'>\n"
            "Distinct forms: <deduped alternate names of the "
            "character's own franchise only — acronyms, common short / "
            "long forms, widely-used alternate canonical spellings. "
            "Comma-separated. Often just one form.>\n"
            "\n"
            "This bucket is anchored on ONE specific character-led "
            "franchise. The Distinct forms line must NEVER include the "
            "Umbrella, nor any sibling franchise that shares the "
            "umbrella, nor any crossover / team-up universe the "
            "character is part of. Including the umbrella OR-unions in "
            "every sibling franchise's films and pollutes results.\n"
            "\n"
            "Examples (assume each is the queried referent):\n"
            "- Superman → Series: Superman; Umbrella: DC Extended "
            "Universe; Distinct forms: superman\n"
            "- James Bond → Series: James Bond; Umbrella: none; "
            "Distinct forms: james bond, 007\n"
            "- Spider-Man → Series: Spider-Man; Umbrella: Marvel "
            "Cinematic Universe; Distinct forms: spider-man\n"
            "- Frodo / Lord of the Rings → Series: The Lord of the "
            "Rings; Umbrella: Middle-earth; Distinct forms: the lord "
            "of the rings, lotr\n"
            "\n"
    ...
    franchise_forms: list[str] = Field(
        ...,
        description=(
            "Every entry from franchise_form_exploration's Distinct "
            "forms line — alternate names of the character's OWN "
            "franchise only. NEVER include the Umbrella value, sibling "
            "franchises that share the umbrella, or crossover "
            "universes the character is part of. Typically a list of "
            "one; two or three only when the franchise has genuinely "
            "different canonical names in common use (acronym + "
            "long form, etc.).\n"
            "\n"
