...
class CategoryCall(BaseModel):
    ...
    retrieval_intent: str = Field(
        ...
        description=(
            ...
            "\n"
            "ALWAYS POPULATED, regardless of role. Carver and "
            "qualifier traits both produce calls; both calls need "
            "Step 4 to understand what's being retrieved. The "
            "carver/qualifier distinction is orchestrator-side and "
            "already committed — Step 4 does not branch on it.\n"
            "\n"
            "What to convey:\n"
            ...
            "window, etc.\n"
            "- For qualifier-source traits, fold in the operational "
            ...
            "- For carver-source traits, name the population the "
            "call gates on so Step 4 understands what to admit / "
            "reject.\n"
            "\n"
            "NEVER:\n"
